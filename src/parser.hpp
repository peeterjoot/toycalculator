...
namespace toy
{
    ...
    class DialectCtx
    {
       public:
        ...
        /// Loads required dialects (Toy, Func, Arith, MemRef, LLVM, SCF).
        DialectCtx();
    };
    ...
    /// ANTLR listener that constructs MLIR for the Toy language.
    ///
    ...
    class MLIRListener : public ToyBaseListener, public antlr4::BaseErrorListener
    {
       ...
       private:
        ...
        /// Creates a toy::ScopeOp and initializes function state.
        ...
        /// Emits a toy::CallOp for a function call.
        ...
        /// Finds enclosing toy::ScopeOp.
        toy::ScopeOp getEnclosingScopeOp( mlir::Location loc, mlir::func::FuncOp funcOp ) const;


        /// Emits toy::ReturnOp (or exit equivalent) with optional value.
