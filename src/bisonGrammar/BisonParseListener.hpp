...
namespace silly
{
    ...
    class BisonParseListener : public Builder
    {
       public:
        ...
        void enterStringDeclareStatement( const silly::TypeAndLoc& type, const silly::StringAndLoc& var,
       ...
       private:
        ...
        void declarationHelper( mlir::Location tLoc, const silly::StringAndLoc& var,
