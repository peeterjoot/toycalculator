...
* easy: lit test for --verbose-link.
* all the tests generated by generate-lit-emit-tests.pl, should mention that script name for regeneration.
* Probably don't need --emit-mlir in add_endtoend_compile_tests any more.
