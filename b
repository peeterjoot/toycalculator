...
#
# gdb -q ../build/silly ; source ../b
#
# (bin/debugit does this)

b main
# pick which sample program to use for the compiler debugging.
#run ../samples/function_plist.silly --stdout --emit-mlir --no-emit-object --debug -g --emit-llvm
#run ../samples/stringlit.silly --stdout --emit-mlir --no-emit-object --debug -g --emit-llvm
run ../samples/function_return.silly --stdout --emit-mlir --no-emit-object --debug -g --emit-llvm
#run ../samples/bool.silly --stdout --emit-mlir --no-emit-object --debug -g --emit-llvm
#run ../samples/function_void_intparm.silly --stdout --emit-mlir --no-emit-object --debug -g --emit-llvm
