...
``` 
    ...
      %7 = sext i32 %6 to i64,
      call void @__toy_print_i64(i64 %7),
      %8 = add i64 %3, 1,
      br label %2,
     
    9:                                                ; preds = %2
    ...
      call void @__toy_print_i64(i64 %15),
      %16 = add i64 %11, 2,
      br label %10,
     
    17:                                               ; preds = %10
...
``` 
    ...
                            18: R_X86_64_PLT32      __toy_print_i64-0x4
      1c:   inc    %rbx
      1f:   cmp    $0xa,%rbx
      23:   jle    10 <main+0x10>
      25:   mov    $0x1,%ebx
    ...
                            38: R_X86_64_PLT32      __toy_print_i64-0x4
      3c:   add    $0x2,%rbx
      40:   cmp    $0xa,%rbx
      44:   jle    30 <main+0x30>
      46:   xor    %eax,%eax
...
``` 
    ...
    11: R_X86_64_PLT32 __toy_print_i64-0x4
      15: mov $0x3,%edi
      1a: call 1f <main+0x1f>
    1b: R_X86_64_PLT32 __toy_print_i64-0x4
      1f: mov $0x4,%edi
      24: call 29 <main+0x29>
    25: R_X86_64_PLT32 __toy_print_i64-0x4
      29: mov $0x5,%edi
      2e: call 33 <main+0x33>
    2f: R_X86_64_PLT32 __toy_print_i64-0x4
      33: mov $0x6,%edi
      38: call 3d <main+0x3d>
    39: R_X86_64_PLT32 __toy_print_i64-0x4
      3d: mov $0x7,%edi
      42: call 47 <main+0x47>
    43: R_X86_64_PLT32 __toy_print_i64-0x4
      47: mov $0x8,%edi
      4c: call 51 <main+0x51>
    4d: R_X86_64_PLT32 __toy_print_i64-0x4
      51: mov $0x9,%edi
      56: call 5b <main+0x5b>
    57: R_X86_64_PLT32 __toy_print_i64-0x4
      5b: mov $0xa,%edi
      60: call 65 <main+0x65>
    61: R_X86_64_PLT32 __toy_print_i64-0x4
      65: mov $0x1,%edi
      6a: call 6f <main+0x6f>
    6b: R_X86_64_PLT32 __toy_print_i64-0x4
      6f: mov $0x3,%edi
      74: call 79 <main+0x79>
    75: R_X86_64_PLT32 __toy_print_i64-0x4
      79: mov $0x5,%edi
      7e: call 83 <main+0x83>
    7f: R_X86_64_PLT32 __toy_print_i64-0x4
      83: mov $0x7,%edi
      88: call 8d <main+0x8d>
    89: R_X86_64_PLT32 __toy_print_i64-0x4
      8d: mov $0x9,%edi
      92: call 97 <main+0x97>
    93: R_X86_64_PLT32 __toy_print_i64-0x4
      97: xor %eax,%eax
      99: pop %rcx
      9a: ret
```
